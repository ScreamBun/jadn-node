...
const schema = {
  ...
  types: [
    ...
    ['OpenC2-Response', 'Map', [], '', [
      ...
      [3, 'results', 'Results', [], 'Map of key:value pairs that contain additional results based on the invoking Command.']
    ]],
    ['Action', 'Enumerated', [], '', [
    ...
    ['Actuator', 'Choice', [], '', []],
    ['Args', 'Map', ['{1'], '', [
      [1, 'start_time', 'Date-Time', [], 'The specific date/time to initiate the Command'],
      [2, 'stop_time', 'Date-Time', [], 'The specific date/time to terminate the Command'],
      [3, 'duration', 'Duration', [], 'The length of time for an Command to be in effect'],
      [4, 'response_requested', 'Response-Type', [], 'The type of Response required for the Command: none, ack, status, complete.']
    ]],
    ...
    ['Results', 'Map', ['{1'], '', [
      [1, 'versions', 'ArrayOf', ['*Version', '{1'], 'List of OpenC2 language versions supported by this Actuator'],
      [2, 'profiles', 'ArrayOf', ['*Nsid', '{0', '}1'], 'List of profiles supported by this Actuator'],
      [3, 'pairs', 'Action-Targets', [], 'List of targets applicable to each supported Action'],
      [4, 'rate_limit', 'Number', [], 'Maximum number of requests per minute supported by design or policy']
    ]],
    ['Artifact', 'Record', ['{1'], '', [
    ...
    ['IPv4-Connection', 'Record', ['{1'], '5-tuple that specifies a tcp/ip connection', [
      ...
      [5, 'protocol', 'L4-Protocol', ['[0'], 'layer 4 protocol (e.g., TCP) - see [Section 3.4.2.9](#3429-l4-protocol)']
    ]],
    ...
    ['IPv6-Connection', 'Record', ['{1'], '5-tuple that specifies a tcp/ip connection', [
      ...
      [4, 'dst_port', 'Port', ['[0'], 'destination service per [RFC6335]'],
      [5, 'protocol', 'L4-Protocol', ['[0'], 'layer 4 protocol (e.g., TCP) - [Section 3.4.2.9](#3429-l4-protocol)']
    ]],
    ...
    ['Targets', 'ArrayOf', ['*$Target', '{1', '}0'], 'List of Target fields'],
    ...
    ['Hashes', 'Map', ['{1'], 'Cryptographic Hash values', [
      [1, 'md5', 'Binary', ['[0', '/x'], 'MD5 hash as defined in [RFC1321]'],
      [2, 'sha1', 'Binary', ['[0', '/x'], 'SHA1 hash as defined in [RFC6234]'],
      [3, 'sha256', 'Binary', ['[0', '/x'], 'SHA256 hash as defined in [RFC6234]']
    ]],
